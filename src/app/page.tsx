    ...
    <div className="min-h-screen bg-gradient-to-br from-[#f8fafc] via-[#EBF1F4] to-[#e2e8f0] p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          {/* Achievement Section */}
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-white/20 group">
            <div className="inline-flex items-center bg-[#A3D977] text-white px-4 py-2 rounded-full text-sm font-semibold mb-4">
              <span className="w-2 h-2 bg-white rounded-full mr-2"></span>
              Achievement
            </div>
            <div className="relative h-48 bg-white/50 rounded-2xl overflow-hidden group-hover:scale-105 transition-transform duration-300">
              <Image
                src="/image/sertifikat/sertifikat juara 2.png"
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-white/20 group">
            ...
            <div className="relative h-48 bg-white/50 rounded-2xl overflow-hidden group-hover:scale-105 transition-transform duration-300">
              <Image
                src="/image/sertifikat/[Coding Camp 2025 - University] Best Capstone Project - FC322D5Y1088 (1).jpg"
                alt="Certificate"
                fill
                className="object-contain p-2"
              />
          ...
          {/* Projects Section */}
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-white/20 group cursor-pointer">
            <div className="inline-flex items-center bg-[#A3D977] text-white px-4 py-2 rounded-full text-sm font-semibold mb-4">
              <span className="w-2 h-2 bg-white rounded-full mr-2"></span>
              Projects
            </div>
            <div className="relative h-48 bg-white/50 rounded-2xl overflow-hidden flex items-center justify-center group-hover:bg-white/70 transition-all duration-300">
              <div className="text-center text-gray-600 group-hover:scale-110 transition-transform duration-300">
                ...
                <p className="text-sm font-medium">View My Projects</p>
